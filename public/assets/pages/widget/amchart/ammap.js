...
(function () {
  ...
  d.formatDuration = function (a, b, c, e, f, g) {
    ...
    "ss" == b &&
      ((a = d.formatNumber(a, g)), 1 == a.split(k)[0].length && (a = "0" + a));
  ...
  d.easeOutElastic = function (a, b, c, e, d) {
    ...
    return (
      h * Math.pow(2, -10 * b) * Math.sin((2 * (b * d - a) * Math.PI) / g) +
      e +
      c
    );
  };
...
(function () {
  ...
  d.polygon = function (a, b, c, e, f, g, h, k, l, m, n) {
    ...
    h = Math.round;
    m &&
      ((b[r] = d.roundTo(b[r], 5)), (c[r] = d.roundTo(c[r], 5)), (h = Number));
    k = "M" + (h(b[0]) + n) + "," + (h(c[0]) + g);
        ...
        if ((a = b.mapContainer)) {
          ...
          if (!isNaN(k)) {
            ...
            var r = Math.sqrt(Math.pow(k - f, 2) + Math.pow(l - g, 2)),
              q = b.initialDistance;
            isNaN(q) &&
              (q = Math.sqrt(Math.pow(k - f, 2) + Math.pow(l - g, 2)));
            if (!isNaN(q)) {
...
(function () {
  ...
  d.SimpleButton = d.Class({
    ...
    init: function (a, b, c, e, f, g, h, k, l, m, n, p, t) {
      ...
      r.svgIcon &&
        ((q = r.svgIcon), t ? q.translate(b, b) : q.translate(b / 2, b / 2));
...
(function () {
  ...
  d.AreasProcessor = d.Class({
    ...
    process: function (a) {
      ...
      for (d = 0; d < c; d++)
        if (
          ((f = a[d]), (f.value = Number(f.value)), (f = f.value), !isNaN(f))
        ) {
          if (!1 === h || h < f) h = f;
          if (!1 === k || k > f) k = f;
          g += Math.abs(f);
