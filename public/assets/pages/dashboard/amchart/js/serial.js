          ...
          if ((g = this.chartData[g])) {
            ...
            if (b.oneBalloonOnly && b.valueBalloonsEnabled) {
              ...
              for (h = d.length - 1; 0 <= h; h--)
                if (
                  ((e = d[h]), e.balloon.enabled && e.showBalloon && !e.hidden)
                ) {
                  l = e.valueAxis.id;
                ...
                k && e != k
                  ...
                  ? ((e.balloon.showBullet = b.bulletsEnabled),
                    ...
                    a.hideBalloons ||
                      ...
                      e.balloon.set &&
                        m.push({ balloon: e.balloon, y: e.balloon.pointToY })))
                  : ((e.currentDataItem = l),
      ...
      if (0 < Math.abs(h) || 0 < Math.abs(e))
        if (isNaN(t))
          (z = q),
            ...
            0 < n &&
              (L = f.line(b, [0, h, d + h], [g, g + e, g + e], p, n, m, x));
        else {
          var N, O, P;
          K
            ? ((N = g / 2),
    ...
    draw: function () {
      ...
      if (f.ifArray(a)) {
        ...
        if (this.parseDates && !this.equalSpacing)
          ...
          r &&
            1 < v &&
            ((t = this.chooseMinorFrequency(v)), f.getPeriodDuration(g, t));
